...
The chat workflow SHALL use n8n's Chat Trigger node (`@n8n/n8n-nodes-langchain.chatTrigger`) as its sole trigger. The user message SHALL flow to the AI Agent via `$json.chatInput`.
